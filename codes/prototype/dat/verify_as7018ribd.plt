...
reset
    ...
    set terminal png
    set output './dat/verify_as7018ribd.png'
set title "Verification time for AS 7018 initialized with as7018ribd"
...
plot "./dat/verify_as7018ribd.dat" using 2:xtic(1) index 1 with linespoints notitle, \
